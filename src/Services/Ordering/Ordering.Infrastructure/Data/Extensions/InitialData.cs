...
internal class InitialData
{
    public static IEnumerable<Customer> Customers =>
        new List<Customer>
        {
            Customer.Create(CustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")),"Thanos","ThanosIsBackEnd@gmail.com"),
        ...
        public static IEnumerable<Order> OrdersWithItems
        {
            get
            {
                var address1 = Address.Of("Thanos", "ozkaya", "ThanosIsBackEnd@gmail.com", "Themistokli No:4", "Greece", "Thessaloniki", "38050");
                var address2 = Address.Of("john", "doe", "john@gmail.com", "Broadway No:1", "England", "Nottingham", "08050");

                var payment1 = Payment.Of("Thanos", "5555555555554444", "12/28", "355", 1);
